	...
	$('#menu-quick-tasks [data-qt-confirm]').each(function() {
		...
		$this.click(function(e) {
			...
			dialog.append('<div class="mdl-dialog__actions">'
					+ '<button type="button" class="mdl-button confirm">' + demyo.l10n['quickTasks.confirm.ok.label'] + '</button>'
					+ '<button type="button" class="mdl-button cancel">' + demyo.l10n['quickTasks.confirm.cancel.label'] + '</button>'
					+ '</div>');
