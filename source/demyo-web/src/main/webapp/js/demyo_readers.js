(function($) {
	...
	demyo.readers.bindReadingListToggles = function () {
		...
		$('#qt-add-album-to-readingList, #fab-remove-readingList').click(demyo.readers.addOrRemoveReadingList);
	};
